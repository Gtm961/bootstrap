...
- Dropdown menus now have a `data-bs-popper="static"` attribute set when the trigger element has `data-bs-display="static"`. This is added by our JavaScript and helps us use custom position styles without interferring with Popper's positioning.
